---
title: "Simulations results: change of genotypes"
...
plotsFolder = "../plots/mainResults_evolutionOfGenotypes"
...
sink(paste0(plotsFolder, "/infoMeasures_s_g_area_abs-centralityMetrics-neutrality.txt"))
...
# write MI and p values to text file
sink(paste0(plotsFolder, "/infoMeasures_s_g_area_abs-centralityMetrics-selection-responded-genes.txt"))
cat(paste0("Variables: s_g_area_abs; absInStrT_sqrt\n",
    "Observed MI: ", obs_MI_absInStrT_sqrt, "; pval: ", pval_MI_absInStrT, "\n", 
    "Variables: s_g_area_abs; absOutStrT_sqrt\n",
    "Observed MI: ", obs_MI_absOutStrT_sqrt, "; pval: ", pval_MI_absOutStrT, "\n"))
